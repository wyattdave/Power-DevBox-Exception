...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
      ...
      if(dAddition==undefined || dAddition==null){
        ...
        dContainer.insertAdjacentHTML('beforeend', '<div style="vertical-align: middle;">'+sImg+'</div>');
        const dAddition=document.querySelector('[id="pdb_exception"]');
        console.log(dPopup)
        ...
        ////
        dAddition.addEventListener("contextmenu", (e) => {console.log(e);e.preventDefault()});
...
function showPopup() { 
  ...
  addEventListener("dblclick", (event) => {
    ...
    aActions.push(sName)
    document.getElementById("actionlist").innerHTML+='<p id="'+sName+'">'+sName+'</p>'
  });
}
